...
void setup()
{
  ...
  eksen1.setMaxSpeed(4000);
  eksen1.setAcceleration(9600);

  eksen2.setMaxSpeed(4000);
  eksen2.setAcceleration(9600);

  eksen3.setMaxSpeed(4000);
  eksen3.setAcceleration(9600);

  eksen4.setMaxSpeed(4000);
  eksen4.setAcceleration(9600);

  eksen5.setMaxSpeed(4000);
  eksen5.setAcceleration(9600);

  eksen6.setMaxSpeed(4000);
...
void loop()
{
  if (Serial.available() > 0)
  {
    ...
    while (command != NULL)
    {
      ...
      acilar[i] = split / 1.8f; /// 0.05625f; // 1/32 step olduğu için:
      i++;
    ...
    eksen1.moveTo(acilar[1]*16);
    eksen2.moveTo(acilar[2]*64);
    eksen3.moveTo(acilar[3]*64);
    eksen4.moveTo(acilar[4]*4);
    eksen5.moveTo(acilar[5]*4);
